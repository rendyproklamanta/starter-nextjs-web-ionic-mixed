         ...
         <div className="card-body p-0 h-full">
            <div className="divide-y divide-slate-100 dark:divide-slate-700 h-full">
               <div className="h-full">
                  ...
                  <footer className="fixed left-0 bottom-0 w-full bg-gray-900 text-white text-center md:px-6 px-4 sm:flex md:space-x-4 sm:space-x-2 rtl:space-x-reverse border-t md:pt-6 pt-4 border-slate-100 dark:border-slate-700">
