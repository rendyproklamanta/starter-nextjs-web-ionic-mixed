      ...
      <>
         <div data-aos="fade">
            <div className="container">
               <div className="row d-flex justify-content-center py-vh-5 pb-0">
                  <div className="col-12 col-lg-10 col-xl-8">
                     <div className="row">
                        <div className="col-12">
                           <h1 className="display-1 fw-bold">Example
                              <span className="fs-4">of a</span><br />
                              content page
                           </h1>
                           <p className="lead border-top pt-5 mt-5" data-aos="fade-up">Lorem ipsum dolor sit amet, consetetur sadipscing
                  ...
                  <div className="row">
                     <div className="col-12 py-vh-2">
                        <Image src="/img/abstract18.webp" width={1446} height={982} alt="abstract image" className="img-fluid position-relative rounded-5 shadow" data-aos="zoom-up" />
                     </div>
                  </div>
                  <div className="col-12 col-lg-10 col-xl-8">
                     <div className="row d-flex align-items-start" data-aos="fade-right">
                        <div className="col-12 col-lg-7">
                           <h2 className="h3 mt-5 border-top pt-5">01. Dolor istam est</h2>
                           <p className="text-secondary">At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd
                     ...
                     <div className="row d-flex align-items-start" data-aos="fade-right">
                        <div className="col-12 col-lg-7">
                           <h2 className="h3 mt-5 border-top pt-5">02. Lorem ipsum</h2>
                           <p className="text-secondary">At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd
                              gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet,
                              consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore
                              et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea
                     ...
                     <div className="row d-flex align-items-start" data-aos="fade-right">
                        <div className="col-12 col-lg-7">
                           <h2 className="h3 mt-5 border-top pt-5">03. Dolor sitam est
                           </h2>
                           <p className="text-secondary">At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd
                              gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet,
                              consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore
                     ...
                     <div className="row d-flex align-items-start" data-aos="fade-right">
                        <div className="col-12 col-lg-7">
                           <h2 className="h3 mt-5 border-top pt-5">04. Eirmod tempor invidunt</h2>
                           <p className="text-secondary">Consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et
                     ...
                     <div className="row d-flex align-items-start" data-aos="fade-right">
                        <div className="col-12 col-lg-7">
                           <h2 className="h3 mt-5 border-top pt-5">05. Lorem ipsum</h2>
                           <p className="text-secondary">At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd
                              gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet,
                              consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore
                              et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea
               ...
               <div className="row d-flex align-items-start justify-content-center py-vh-3 text-muted" data-aos="fade">
